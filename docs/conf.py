...
environ.setdefault("DJANGO_SETTINGS_MODULE", "test_app.settings")
django.setup()
...
release = get_distribution("django-smart-selects").version
...
htmlhelp_basename = "DjangoSmartSelectsdoc"
...
latex_documents = [(master_doc, "DjangoSmartSelects.tex", title, author, "manual")]

# -- Options for manual page output ---------------------------------------

# One entry per manual page. List of tuples
# (source start file, name, description, authors, manual section).
man_pages = [(master_doc, "djangosmartselectcs", description, [author], 1)]
